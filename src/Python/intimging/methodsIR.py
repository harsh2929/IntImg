...
try:
    from intimg.supp.addmodules import RING_WEIGHTS
except ImportError:
...
def dict_check(self, _data_, _algorithm_, _regularisation_):
    ...
    if self.geom == '2D':
        from intimg.supp.astraOP import AstraTools, AstraToolsOS
        ...
        from intimg.supp.astraOP import AstraTools3D, AstraToolsOS3D
